...
import { applyDistance, getProximitySpeedFactor, move, spin } from "tsparticles-move-base/browser/Utils";
import type { MoveParticle } from "tsparticles-move-base/types/Types";
